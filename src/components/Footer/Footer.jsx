        ...
        <section>
          <a href="#">
            <i className="icon-wrapper">
              <FontAwesomeIcon icon={faFacebook} style={{ color: "#49f3f1" }} />
            </i>
          </a>
          <a href="#">
            <i className="icon-wrapper">
              <FontAwesomeIcon icon={faInstagram} style={{ color: "#49f3f1" }} />
            </i>
          </a>
          <a href="#">
            <i className="icon-wrapper">
              <FontAwesomeIcon icon={faLinkedin} style={{ color: "#49f3f1" }} />
            </i>
          </a>
          <a href="#">
            <i className="icon-wrapper">
              <FontAwesomeIcon icon={faGithub} style={{ color: "#49f3f1" }} />
            </i>
          </a>
        </section>
        <p>
